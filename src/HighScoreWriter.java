...
public class HighScoreWriter {
    ...
    public void writeHealth(String name, int health) throws IOException {
        boolean append = true;
        FileWriter writer = null;
        try {
            writer = new FileWriter(fileName, append);
            writer.write(name + "," + health + "\n");
        } finally {
            if (writer != null) {
                writer.close();
            }
    ...
    public void writeFuel(String name, int fuel) throws IOException {
        boolean append = true;
        FileWriter writer = null;
        try {
            writer = new FileWriter(fileName, append);
            writer.write(name + "," + fuel + "\n");
        } finally {
            if (writer != null) {
                writer.close();
            }
